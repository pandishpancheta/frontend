...
const TagInput = ({
  ...
  return (
    <>
      <div
        className={`grow-1 relative flex w-full flex-wrap items-start justify-start gap-2 rounded-lg border p-2 text-text-secondary
        ${
          errors &&
...
const Tag = ({ tag, handleRemoveTag }: TagProps) => (
  ...
  >
    ...
    >
      <IconX
        size={16}
        className='hover:text-blue text-text-secondary transition-colors'
      />
    </button>
  </div>
);
